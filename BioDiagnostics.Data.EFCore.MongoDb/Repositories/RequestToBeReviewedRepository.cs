...
namespace BioDiagnostics.Data.EFCore.MongoDb.Repositories;
...
public class RequestToBeReviewedRepository : IRequestToBeReviewedRepository
{
  ...
  internal protected DbSet<RequestToBeReviewedMongo> GetEntities() => _dbContext.RequestToBeRevieweds;
