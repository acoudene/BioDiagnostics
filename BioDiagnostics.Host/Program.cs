...
using BioDiagnostics.Api;
using BioDiagnostics.Host;
...
try
{
  ...
  var mongoConnectionString = builder.Configuration.GetConnectionString("biodiagnostics");
  ...
  builder.Services.AddControllers(options =>
                  ...
                  .ConfigureApplicationPartManager(apm => apm.ApplicationParts.Add(new AssemblyPart(typeof(RequestToBeReviewedController).Assembly)))
                  ;
